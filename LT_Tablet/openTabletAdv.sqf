...
_loadArr = ["Empty","Custom","Crate Small","Crate Medium","Crate Large","Crate Explosives","Crate Medical","Crate Weapons","Crate NVG","Crate Comms","Crate Air"]; //every case in LT_fnc_vehicleLoadout
{
	lbAdd [621, _x];
